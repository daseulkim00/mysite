		...
		<div id="content">
			<div id="board">
				...
				<table class="tbl-ex">
					...
					<tr>
						<td>3</td>                   <!-- ${20*vo.depth } -->
						<td style="text-align:left; padding-left:20px"><a href="">세 번째 글입니다.</a></td>
						<td>안대혁</td>
						<td>3</td>
					...
					<tr>
						<td>2</td>
						<td style="text-align:left; padding-left:${20*vo.depth }px"><img src='${pageContext.servletContext.contextPath }/assets/images/reply.png'/><a href="">두 번째 글입니다.</a></td>
						<td>안대혁</td>
						<td>3</td>
